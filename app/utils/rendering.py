...
<head>
    ...
    <style>
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        .markdown-body {{ line-height: 1.8; color: #c8c8e0; }}
        ...
        .markdown-body h1 {{ font-size: 2em; border-bottom: 1px solid #1e1e32; padding-bottom: 0.3em; }}
        .markdown-body h2 {{ font-size: 1.5em; border-bottom: 1px solid #1e1e32; padding-bottom: 0.2em; }}
        ...
        .markdown-body tr:nth-child(even) {{ background: #151525; }}
        .markdown-body img {{
            max-width: 100%;
            height: auto;
            border-radius: 8px;
        ...
        .markdown-body .toc ul {{ list-style: none; padding-left: 1em; }}
        .markdown-body .toc > ul {{ padding-left: 0; }}
        .markdown-body .toc a {{ color: #8888aa; font-size: 13px; }}
        .markdown-body .toc a:hover {{ color: #a78bfa; }}
    </style>
</head>
<body>
    <header>
